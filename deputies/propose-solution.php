                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Propose Solution</a></li>
                                <li><a href="#reviews">Submit Document related to Solution</a></li>
                                <li><a href="#1reviews">Submit it to Goverment Agency</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <textarea name="SolutionDescription" placeholder="Solution Description"></textarea>
                                                                </div>
                                ...
                                <div class="product-tab-list tab-pane fade" id="1reviews">
                                    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="/upload" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                    <input name="Deadline" type="number" class="form-control" placeholder="Deadline">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="governmentagency" type="text" class="form-control" placeholder="Government Agency">
                                                                </div>
                                                                <div class="form-group">
