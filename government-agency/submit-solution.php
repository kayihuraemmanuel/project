...
<head>
    ...
    <title>Submit Solution | CHADISS</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h3>Submit Solution to this issue of Kurenganywa Kubera Ruswa</h3>
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Submit Solution</a></li>
